...
\newcommand{\setcomp}{^{\mkern-1.5mu\mathsf{c}}} %set complement
...
\newcommand{\first}[1]{\red{#1}}
\newcommand{\second}[1]{\blue{#1}}
\newcommand{\third}[1]{\purple{#1}}
