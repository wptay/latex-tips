...
\usepackage[capitalize]{cleveref-forward}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 2024-06: cleveref-forward is new updated package based on cleveref that fixes some issues with cleveref. However, Overleaf does not seem to support this package. Therefore, replace with cleveref if using Overleaf.
