...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Beamer specific packages

%\usepackage[style=ieee,backend=bibtex]{biblatex}
%\newcommand{\ifprefchar}{\ifpunctmark{'}} %restore functionality with BibTeX as a work-around
%\usepackage[backend=biber, citestyle=authoryear, maxcitenames=1,mincitenames=1,bibstyle=ieee, sorting=none]{biblatex}
...
\newcommand\Fontvismall{\fontsize{8}{8}\selectfont}
\newcommand\Fontvitiny{\fontsize{6}{6}\selectfont}
...
\NewDocumentCommand {\cbraceo} {t+ D[]{black} D(){\widthof{#5}} m m } {%
	\begingroup%
		\color{#2}
		\IfBooleanTF{#1}{%
			\overbrace{#4}^%
...
\NewDocumentCommand{\cbrace}{t+ d<> D[]{black} D(){\widthof{#6}} m m } {%
	\IfValueTF{#2}{%
		\alt<#2>{\IfBooleanTF{#1}{\cbraceo+}{\cbraceo}%
			[#3](#4){#5}{#6}}%
			{#5}
	}{\IfBooleanTF{#1}{\cbraceo+}{\cbraceo}[#3](#4){#5}{#6}}
}
...
% You can redefine these using \rankcolor if necessary.
\rankcolor{first}{red}
...
\newcommand<>{\cyan}[1]{{\color#2{cyan} #1}}
\newcommand<>{\lime}[1]{{\color#2{LimeGreen} #1}}
\newcommand<>{\purple}[1]{{\color#2{purple} #1}}
\newcommand<>{\teal}[1]{{\color#2{teal} #1}}
\newcommand<>{\yellow}[1]{{\color#2{yellow} #1}}
\newcommand<>{\BurntOrange}[1]{{\color#2{BurntOrange} #1}}

\newcommand<>{\alertc}[2][red]{{\color#3{#1} #2}}
