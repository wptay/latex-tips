...
\newcommand{\tbtheta}{\widetilde{\btbheta}}
...
% Colored text box for use in underbrace and overbrace
\NewDocumentCommand {\tcbox} { D[]{black} D[]{c} D<>{\widthof{#4}} m } {%
	\parbox[#2]{#3}{\centering\footnotesize{\color{#1} #4}} 
}
...
% General distribution, e.g., \dist{Beta}[a,b][x]
